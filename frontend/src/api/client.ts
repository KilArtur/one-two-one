...
export async function generateCoreQuestions(token: string, vacancyId: string): Promise<unknown[]> {
  const response = await fetch(`${API_BASE_URL}/vacancies/${vacancyId}/questions/generate`, {
    method: "POST",
